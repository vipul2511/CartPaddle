    ...
    return (
      <View style={this.props.menustyle}>
        <Menu
         ...
         <MenuItem onPress={this.option1Click}>Take Photo</MenuItem>
          <MenuItem onPress={this.option2Click}>Choose Photo</MenuItem>
          <MenuItem onPress={this.option3Click}>Edit</MenuItem>
