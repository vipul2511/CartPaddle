        ...
        <View style={styles.MainContentBox}>
          ...
          <Container>
            ...
            <Tabs tabBarUnderlineStyle={{ backgroundColor: '#F01738' }} tabBarActiveTextColor={'red'} tabBarInactiveTextColor='#7F7F7F' >
              <Tab heading={<TabHeading style={{ backgroundColor: '#fff' }}><Text style={{ fontWeight: 'bold' }}>Cart </Text></TabHeading>}>
                <CartPlaceScreen />
              </Tab>
              <Tab heading={<TabHeading style={{ backgroundColor: '#fff' }}><Text style={{ fontWeight: 'bold' }}>Order Placed</Text>
           
              </TabHeading>}>
                <OderPlacedScreen />
              </Tab>
              <Tab heading={<TabHeading style={{ backgroundColor: '#fff' }}><Text style={{ fontWeight: 'bold' }}>Order Received</Text></TabHeading>}>
                <OderReceivedScreen />
              </Tab>
